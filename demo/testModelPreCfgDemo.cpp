...
/***************************************** 
   ...
   place the contents of serialized .bin file to the model file before releasing and
   then ensure preprocessing is self-explanatory when performing deep learning inference
*****************************************/
